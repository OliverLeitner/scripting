...
#this is a special for usenet trojan crap
find $1 -name "*.exe" -type f -exec rm {} \;
...
#latest shit found...
find $1 \( -name "bonus.rar" -o -name "Bonus.rar" -o -name "BONUS.rar" \) -type f -exec rm {} \;
find $1 -name "*.doc" -type f -exec rm {} \;
find $1 -name "*.txt" -type f -exec rm {} \;
find $1 -name "sex-dating.jpg" -type f -exec rm {} \;
